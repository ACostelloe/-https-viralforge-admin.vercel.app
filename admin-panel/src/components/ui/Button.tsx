...
export default function Button({
  ...
  const variantClasses: Record<string, string> = {
    ...
    secondary: 'bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 focus:ring-accent-400',
    danger: 'bg-error-500 hover:bg-red-600 text-white focus:ring-error-500'
  }
